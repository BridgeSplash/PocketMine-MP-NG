...
final class VanillaBlockMappings{
	...
	private static function registerSimpleIdOnlyMappings(BlockSerializerDeserializerRegistrar $reg) : void{
		...
		$reg->mapHorizontallyConnected(Blocks::GLASS_PANE(), Ids::GLASS_PANE);
		...
		$reg->mapHorizontallyConnected(Blocks::HARDENED_GLASS_PANE(), Ids::HARD_GLASS_PANE);
		...
		$reg->mapHorizontallyConnected(Blocks::IRON_BARS(), Ids::IRON_BARS);
		...
		$reg->mapHorizontallyConnected(Blocks::NETHER_BRICK_FENCE(), Ids::NETHER_BRICK_FENCE);
	...
	private static function registerWoodMappings(BlockSerializerDeserializerRegistrar $reg, CommonProperties $commonProperties) : void{
		...
		foreach([
			...
			$reg->mapHorizontallyConnected($block, $id);
		}
	...
	private static function register1to1CustomMappings(BlockSerializerDeserializerRegistrar $reg, CommonProperties $commonProperties) : void{
		...
		$reg->mapModel(Model::create(Blocks::TRIPWIRE(), Ids::TRIP_WIRE)->properties([
			...
			//PM doesn't track which sides the wire is connected to - these only affect the client-side model
			BoolProperty::unused(StateNames::MC_CONNECTION_NORTH, false),
			BoolProperty::unused(StateNames::MC_CONNECTION_SOUTH, false),
			BoolProperty::unused(StateNames::MC_CONNECTION_WEST, false),
			BoolProperty::unused(StateNames::MC_CONNECTION_EAST, false),
		]));
